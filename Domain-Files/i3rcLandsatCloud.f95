...
! $URL: http://i3rc-monte-carlo-model.googlecode.com/svn/trunk/I3RC-Examples/i3rcLandsatCloud.f95 $
...
program i3rcLandsatCloud
  ...
  real,    dimension(nX, nY, nLayers)  :: extinction = 0., singleScatteringAlbedo = 0., temps = 0.
