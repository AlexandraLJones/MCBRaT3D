...
program opticalPropertiesToDomain
 ...
 ! $URL: http://i3rc-monte-carlo-model.googlecode.com/svn/trunk/Tools/OpticalPropertiesToDomain.f95 $
 ...
 !    Frank Evans    University of Colorado     December 2005
  ...
  allocate (extinct(nX,nY,nZ), ssa(nX,nY,nZ), phaseFuncIndex(nX,nY,nZ), temps(nx,ny,nz))
  extinct(:,:,:) = 0.0  ;  ssa(:,:,:) = 0.0  ; phaseFuncIndex(:,:,:) = 1  ; temps(:,:,:) = 0.0
  readProps: do
